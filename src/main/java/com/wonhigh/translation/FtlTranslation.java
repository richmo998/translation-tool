 ...
 * @description:
 */
public class FtlTranslation extends BaseTranslation {

    private static Logger logger = Logger.getLogger(FtlTranslation.class);
    ...
    public List<String> translate(List<String> fileList, String language) {
        ...
        for (String line : fileList) {
            ...
            if ((line.contains(Constants.ANNOTATION_FTL_START) ||
                    line.contains(Constants.ANNOTATION_HTML_XML_START))
                    && line.contains(Constants.ANNOTATION_FTL_END)) {
                //单行全为注释
                translationList.add(line);
                continue;

            } else if ((line.contains(Constants.ANNOTATION_FTL_START) ||
                    line.contains(Constants.ANNOTATION_HTML_XML_START))
                    && !line.contains(Constants.ANNOTATION_FTL_END)) {
                //多行注释开始
                translationList.add(line);
                ...
                //多行注释还未结束
                translationList.add(line);
                if (line.contains(Constants.ANNOTATION_FTL_END)) {
                    //多行注释结束
